...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Blaton', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专业物理老师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hexo.blatonshop.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '物理, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jiangst1005011841@gmail.com', // 邮箱地址 例如mail@tangly1024.com
